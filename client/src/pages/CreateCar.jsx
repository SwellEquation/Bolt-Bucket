        ...
        >
          ...
          {[{ left: '28px' }, { right: '28px' }].map((pos, i) => (
            <div key={i} style={{
              ...
              borderRadius: '50%', backgroundColor: form.wheel_type === 'luxury' ? '#c9a84c' : form.wheel_type === 'sport' ? '#333' : '#555',
      ...
      <article style={{ minWidth: '300px', maxWidth: '480px', flex: 1 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <input type="submit" value={submitting ? 'Saving...' : `Save Car — $${price.toLocaleString()}`} disabled={submitting} />
          </div>
        </form>
      </article>
    </main>
